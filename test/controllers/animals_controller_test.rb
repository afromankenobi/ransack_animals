...
class AnimalsControllerTest < ActionController::TestCase
  ...
  test "should create animal" do
    assert_difference('Animal.count') do
      post :create, animal: { amount: @animal.amount, category_id: @animal.category_id, name: @animal.name }
    end
  ...
  test "should update animal" do
    patch :update, id: @animal, animal: { amount: @animal.amount, category_id: @animal.category_id, name: @animal.name }
    assert_redirected_to animal_path(assigns(:animal))
  end
